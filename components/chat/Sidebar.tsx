...
export function Sidebar({ isOpen, onToggle }: SidebarProps) {
  return (
    <>
      ...
      <button
        onClick={onToggle}
        className={`hidden md:block fixed top-4 z-50 p-2 rounded-lg bg-zinc-900 border border-zinc-800/50 text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-all duration-300 ${
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-40 h-full w-64 bg-zinc-950 border-r border-zinc-800/50 transition-transform duration-300 ease-out ${
